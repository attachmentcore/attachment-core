...
//input models
class AttachmentKeyModel {
}
class AttachmentItemUploadModel extends AttachmentKeyModel {
}
...
const Tunnel = createProviderConsumer(null, (subscribe, child) => (__chunk_1.h("context-consumer", { subscribe: subscribe, renderer: child })));

class CreateComponent {
    constructor(hostRef) {
        __chunk_1.registerInstance(this, hostRef);
        this.onCreate = __chunk_1.createEvent(this, "onCreate", 7);
        this.onRequest = __chunk_1.createEvent(this, "onRequest", 7);
    }
    renderCreate() {
        let className = "";
        if (!this.files || this.files.length == 0)
            className = "disabled";
        return __chunk_1.h("p", { class: "control" }, __chunk_1.h("a", { class: "button is-success is-outlined " + className, onClick: () => this.postAttachment() }, __chunk_1.h("span", { class: "icon " }, __chunk_1.h("attachment-icon", { "icon-name": "ok" })), __chunk_1.h("span", null, "Create")));
    }
    postAttachment() {
    ...
    render() {
        return [
            __chunk_1.h("div", { class: "create-form field is-grouped" }, __chunk_1.h("p", { class: "control is-expanded" }, __chunk_1.h("input", { class: "input", type: "file", name: "files", multiple: true, id: "file", ref: el => this.fileInput = el, onChange: ($event) => { this.files = $event.target.files; } }), __chunk_1.h("input", { class: "input", type: "text", placeholder: "Description", ref: el => this.descriptionInput = el, value: this.description, onInput: ($event) => this.description = $event.target.value })), this.renderCreate())
        ];
    }
    static get style() { return ".create-form input.input{display:inline-block;width:49.5%}.create-form input.input[type=file]{margin-right:1%}.create-form p{margin-top:4px;margin-bottom:4px}.create-form .button.disabled{opacity:.7;pointer-events:none;cursor:not-allowed}"; }
}
...
class IconComponent {
    ...
    render() {
        let path = IconTypes[this.IconName];
        return (__chunk_1.h("svg", { class: "svg-icon", viewBox: "0 0 20 20" }, path.map(value => __chunk_1.h("path", { d: value }))));
    }
}
...
class AttachmentInputComponent {
    constructor(hostRef) {
        __chunk_1.registerInstance(this, hostRef);
        this.loading = false;
        this.error = false;
    ...
    renderIcon() {
        if (this.error)
            return (__chunk_1.h("div", { class: "control " }, __chunk_1.h("a", { class: "button is-danger", onClick: () => { this.getAttachmentId(); } }, __chunk_1.h("span", { class: "icon is-small" }, __chunk_1.h("attachment-icon", { "icon-name": "retry" })))));
        if (!this.loading)
            return (__chunk_1.h("div", { class: "control " }, __chunk_1.h("a", { class: "button is-info", onClick: () => { this.openModal(); } }, __chunk_1.h("span", { class: "icon is-small" }, __chunk_1.h("attachment-icon", { "icon-name": "attachment" })))));
    }
    renderModal() {
        if (this.Attachment && this.Attachment.attachmentId) {
            ...
            return (__chunk_1.h(Tunnel.Provider, { state: { AttachmentKey: attachmentKey, AttachmentBusiness: this.attachmentBusiness } }, __chunk_1.h("attachment-modal", { ref: el => (this.modal = el) })));
        }
    }
    componentDidLoad() {
    ...
    render() {
        return [
            __chunk_1.h("div", { class: "field has-addons attachment-core-input" }, __chunk_1.h("div", { class: "control " + (this.loading ? "is-loading" : "") }, __chunk_1.h("input", { class: "input", type: "text", placeholder: this.Placeholder ? this.Placeholder : "" })), this.renderIcon()),
            this.renderModal()
        ];
    }
...
class ModalComponent {
    ...
    renderReloader() {
        return __chunk_1.h("a", { class: "button is-info spinner " + (this.loading ? "is-loading" : ""), onClick: () => this.load(this.pageItems.pageIndex, this.pageItems.pageSize) }, __chunk_1.h("span", { class: "icon is-small" }, !this.loading ? [__chunk_1.h("attachment-icon", { "icon-name": "reload" })] : []));
    }
    renderPager() {
        if (!this.pageItems)
            return;
        ...
        if (first != last)
            return (__chunk_1.h("nav", { class: "pagination is-centered", role: "navigation", "aria-label": "pagination" }, __chunk_1.h("ul", { class: "pagination-list" }, first < this.pageItems.pageIndex ? [__chunk_1.h("li", null, __chunk_1.h("a", { class: "pagination-link", "aria-label": "Goto page 1", onClick: () => { this.load(first, this.pageItems.pageSize); } }, first))] : [], first + 1 < prev ? [__chunk_1.h("li", null, __chunk_1.h("span", { class: "pagination-ellipsis" }, "\u2026"))] : [], first < prev ? [__chunk_1.h("li", null, __chunk_1.h("a", { class: "pagination-link", "aria-label": "Goto page 45", onClick: () => { this.load(prev, this.pageItems.pageSize); } }, prev))] : [], this.pageItems.totalItemsCount != 0 ? __chunk_1.h("li", null, __chunk_1.h("a", { class: "pagination-link is-current", "aria-label": "Page 46", "aria-current": "page" }, this.pageItems.pageIndex)) : [], last > next ? [__chunk_1.h("li", null, __chunk_1.h("a", { class: "pagination-link", "aria-label": "Goto page 47", onClick: () => { this.load(next, this.pageItems.pageSize); } }, next))] : [], last - 1 > next ? [__chunk_1.h("li", null, __chunk_1.h("span", { class: "pagination-ellipsis" }, "\u2026"))] : [], last > this.pageItems.pageIndex ? [__chunk_1.h("li", null, " ", __chunk_1.h("a", { class: "pagination-link", "aria-label": "Goto page 86", onClick: () => { this.load(last, this.pageItems.pageSize); } }, last))] : [])));
    }
    render() {
        let classNames = "";
        if (this.loading)
            classNames += " loading";
        return [
            __chunk_1.h("attachment-popup", { class: classNames, ref: el => (this.popup = el) }, __chunk_1.h("div", { class: "modal-card" }, __chunk_1.h("header", { class: "modal-card-head" }, __chunk_1.h("label", { class: "modal-card-title" }, "Attachments List")), __chunk_1.h("section", { class: "modal-card-body " + (this.loading ? "disabled" : "") }, __chunk_1.h("attachment-table", { ref: el => (this.table = el) })), __chunk_1.h("footer", { class: "modal-card-foot" }, this.renderPager(), this.renderReloader()), __chunk_1.h("button", { class: "modal-close is-large", onClick: () => this.popup.close(), "aria-label": "close" })))
        ];
    }
    get el() { return __chunk_1.getElement(this); }
    static get style() { return "attachment-modal>attachment-popup>.modal>.modal-card>.modal-card-body.disabled{pointer-events:none;opacity:.7}attachment-modal>attachment-popup>.modal>.modal-card>.modal-card-head{padding:5px}attachment-modal>attachment-popup>.modal>.modal-card>.modal-card-head .modal-card-title{padding-left:15px;padding-bottom:10px;padding-top:10px;font-size:18px!important;font-weight:700}attachment-modal>attachment-popup>.modal>.modal-card>.modal-card-foot{padding:5px}attachment-modal>attachment-popup>.modal>.modal-card>.modal-card-foot ul{padding-left:15px;list-style-type:none}attachment-modal>attachment-popup>.modal>.modal-card>.modal-card-foot .button.spinner{margin-left:auto;margin-right:15px;-ms-flex-order:2;order:2}"; }
}
...
class PopupComponent {
    constructor(hostRef) {
        __chunk_1.registerInstance(this, hostRef);
        this.onOpen = __chunk_1.createEvent(this, "onOpen", 7);
        this.onClose = __chunk_1.createEvent(this, "onClose", 7);
    }
    componentDidLoad() {
    }
    async open() {
    ...
    render() {
        return [
            __chunk_1.h("div", { class: "modal", ref: el => this.wrapper = el }, __chunk_1.h("div", { class: "modal-background", onClick: () => this.close() }), __chunk_1.h("slot", null))
        ];
    }
    get el() { return __chunk_1.getElement(this); }
...
class TableComponent {
    constructor(hostRef) {
        __chunk_1.registerInstance(this, hostRef);
        this.onStartLoading = __chunk_1.createEvent(this, "onStartLoading", 7);
        this.onEndLoading = __chunk_1.createEvent(this, "onEndLoading", 7);
    }
    componentDidLoad() {
    ...
    renderDeleteButton(attachmentItem) {
        return (__chunk_1.h("a", { class: "button is-danger is-small is-outlined ", onClick: () => this.delete(attachmentItem) }, __chunk_1.h("span", { class: "icon is-small" }, __chunk_1.h("attachment-icon", { "icon-name": "delete" }))));
    }
    renderDownloadButton(attachmentItem) {
        return (__chunk_1.h("a", { class: "button is-primary is-small is-outlined ", onClick: () => { this.download(attachmentItem); } }, __chunk_1.h("span", { class: "icon is-small" }, __chunk_1.h("attachment-icon", { "icon-name": "download" }))));
    }
    renderInfoButton(attachmentItem) {
        return (__chunk_1.h("a", { class: "button is-info is-small is-outlined ", onClick: () => this.info(attachmentItem) }, __chunk_1.h("span", { class: "icon is-small" }, __chunk_1.h("attachment-icon", { "icon-name": "details" }))));
    }
    renderRows() {
        if (this.pageItems)
            return this.pageItems.items.map((item, index) => {
                let id = ((this.pageItems.pageIndex - 1) * this.pageItems.pageSize) + index + 1;
                return (__chunk_1.h("tr", null, __chunk_1.h("td", { "data-column": "Id" }, id), __chunk_1.h("td", { "data-column": "Name" }, item.fileName), __chunk_1.h("td", { "data-column": "Description" }, item.description), __chunk_1.h("td", { "data-column": "Operations" }, this.renderDownloadButton(item), this.renderInfoButton(item), this.renderDeleteButton(item))));
            });
    }
    render() {
        return [
            __chunk_1.h("attachment-create", { "attachment-key": this.AttachmentKey, ref: el => (this.create = el) }),
            __chunk_1.h("table", { class: "table is-bordered is-striped is-narrow is-hoverable is-fullwidth" }, __chunk_1.h("thead", null, __chunk_1.h("tr", null, __chunk_1.h("th", { class: "id" }, "Id"), __chunk_1.h("th", { class: "name" }, "Name"), __chunk_1.h("th", { class: "description" }, "Description"), __chunk_1.h("th", { class: "operations" }, "Operations"))), __chunk_1.h("tbody", null, this.renderRows())),
            __chunk_1.h("delete-comfirmation", { ref: el => this.deleteComfirmation = el }),
            __chunk_1.h("info-dialog", { ref: el => this.infoDialog = el }),
        ];
    }
    static get style() { return "ul.pagination-list{margin-top:0;margin-bottom:0}table{border-collapse:collapse;table-layout:fixed;width:100%;margin-bottom:0!important}table tr:last-child td:first-child{border-bottom-left-radius:4px}table tr:last-child td:last-child{border-bottom-right-radius:4px}tr:nth-of-type(odd){background:#eee}th{background:#6392f5;color:#fff;font-weight:400;padding:7px;text-align:left;font-size:18px}th.id{width:10%;text-align:center!important}th.name{width:30%}th .description{width:40%}td{padding:5px;border:2px solid #aaa;word-break:break-all}td[data-column=Id]{text-align:center}td .button{margin-right:3px}\@media (min-device-width:768px) and (max-device-width:1024px),only screen and (max-width:760px){table{width:100%}th{text-align:left}th.id{text-align:left!important}td[data-column=Id]{text-align:left}tbody,td,th,thead,tr{vertical-align:middle!important;display:block}thead tr{position:absolute;top:-9999px;left:-9999px}tr{border:1px solid #ccc}td{border:none;position:relative;padding-left:50%!important}td:before{position:absolute;top:6px;left:6px;width:45%;padding-right:10px;white-space:nowrap;content:attr(data-column);color:#000;font-weight:700}}.pager{padding:5px;border-bottom:2px solid #aaa;border-left:2px solid #aaa;border-right:2px solid #aaa}.pager span.page-numbers{padding:5px;display:inline-block;vertical-align:middle}"; }
}
...
class DeleteComfirmationComponent {
    constructor(hostRef) {
        __chunk_1.registerInstance(this, hostRef);
        this.onAccept = __chunk_1.createEvent(this, "onAccept", 7);
        this.onCancel = __chunk_1.createEvent(this, "onCancel", 7);
    }
    ...
    renderAccept() {
        return (__chunk_1.h("a", { class: "button is-primary is-outlined", onClick: () => { this.accept(this.attachmentItem); } }, __chunk_1.h("span", { class: "icon is-small" }, __chunk_1.h("attachment-icon", { "icon-name": "ok" })), __chunk_1.h("span", null, "OK")));
    }
    renderCancel() {
        return (__chunk_1.h("a", { class: "button is-danger is-outlined", onClick: () => { this.cancel(this.attachmentItem); } }, __chunk_1.h("span", { class: "icon is-small" }, __chunk_1.h("attachment-icon", { "icon-name": "delete" })), __chunk_1.h("span", null, "Cancel")));
    }
    renderInfo() {
        if (this.attachmentItem)
            return (__chunk_1.h("ul", null, __chunk_1.h("li", null, __chunk_1.h("b", null, "Name "), " ", this.attachmentItem.fileName), __chunk_1.h("li", null, __chunk_1.h("b", null, "Description "), " ", this.attachmentItem.description), __chunk_1.h("li", null, __chunk_1.h("b", null, "Size "), " ", FormatSize(this.attachmentItem.fileSize)), __chunk_1.h("li", null, __chunk_1.h("b", null, "UploadDate "), " ", FormatDate(this.attachmentItem.uploadDate))));
    }
    render() {
        return [
            __chunk_1.h("attachment-popup", { ref: el => this.popup = el }, __chunk_1.h("div", { class: "modal-card" }, __chunk_1.h("header", { class: "modal-card-head" }, __chunk_1.h("label", { class: "modal-card-title" }, "Delete Confirmation")), __chunk_1.h("section", { class: "modal-card-body" }, __chunk_1.h("h1", null, "Are you sure to delete this file attachment?"), this.renderInfo()), __chunk_1.h("footer", { class: "modal-card-foot" }, this.renderAccept(), this.renderCancel())))
        ];
    }
    static get style() { return "delete-comfirmation>attachment-popup>.modal>.modal-card>.modal-card-head{padding:5px}delete-comfirmation>attachment-popup>.modal>.modal-card>.modal-card-head .modal-card-title{padding-left:15px;padding-bottom:10px;padding-top:10px;font-size:18px!important;font-weight:700}delete-comfirmation ul{columns:2;-webkit-columns:2;-moz-columns:2;list-style-type:none}delete-comfirmation ul b{display:block;margin-right:.5em}delete-comfirmation ul li{word-break:break-all}"; }
}
...
class InfoDialogComponent {
    ...
    renderClose() {
        return (__chunk_1.h("a", { class: "button is-danger is-outlined", onClick: () => { this.close(); } }, __chunk_1.h("span", { class: "icon is-small" }, __chunk_1.h("attachment-icon", { "icon-name": "delete" })), __chunk_1.h("span", null, "CLose")));
    }
    renderInfo() {
        if (this.attachmentItem)
            return (__chunk_1.h("ul", null, __chunk_1.h("li", null, __chunk_1.h("b", null, "Name"), " ", this.attachmentItem.fileName), __chunk_1.h("li", null, __chunk_1.h("b", null, "Description"), " ", this.attachmentItem.description), __chunk_1.h("li", null, __chunk_1.h("b", null, "Size"), " ", FormatSize(this.attachmentItem.fileSize)), __chunk_1.h("li", null, __chunk_1.h("b", null, "UploadDate"), " ", FormatDate(this.attachmentItem.uploadDate))));
    ...
    render() {
        return [
            __chunk_1.h("attachment-popup", { ref: el => (this.popup = el) }, __chunk_1.h("div", { class: "modal-card" }, __chunk_1.h("header", { class: "modal-card-head" }, __chunk_1.h("label", { class: "modal-card-title" }, "Attachment Item Details")), __chunk_1.h("section", { class: "modal-card-body" }, this.renderInfo()), __chunk_1.h("footer", { class: "modal-card-foot" }, this.renderClose())))
        ];
    }
    static get style() { return "info-dialog>attachment-popup>.modal>.modal-card>.modal-card-head{padding:5px}info-dialog>attachment-popup>.modal>.modal-card>.modal-card-head .modal-card-title{padding-left:15px;padding-bottom:10px;padding-top:10px;font-size:18px!important;font-weight:700}info-dialog ul{columns:2;-webkit-columns:2;-moz-columns:2;list-style-type:none}info-dialog ul b{display:block;margin-right:.5em}info-dialog ul li{word-break:break-all}"; }
}

exports.attachment_create = CreateComponent;
exports.attachment_icon = IconComponent;
exports.attachment_input = AttachmentInputComponent;
exports.attachment_modal = ModalComponent;
exports.attachment_popup = PopupComponent;
exports.attachment_table = TableComponent;
exports.context_consumer = ContextConsumer;
exports.delete_comfirmation = DeleteComfirmationComponent;
exports.info_dialog = InfoDialogComponent;
