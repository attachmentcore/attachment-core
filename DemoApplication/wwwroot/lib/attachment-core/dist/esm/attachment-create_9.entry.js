...
const Tunnel = createProviderConsumer(null, (subscribe, child) => (h("context-consumer", { subscribe: subscribe, renderer: child })));
...
class IconComponent {
    ...
    render() {
        ...
        return (h("svg", { class: "svg-icon", viewBox: "0 0 20 20" }, path.map(value => h("path", { d: value }))));
    }
}
...
class AttachmentInputComponent {
    ...
    renderIcon() {
        if (this.error)
            return (h("div", { class: "control " }, h("a", { class: "button is-danger", onClick: () => { this.getAttachmentId(); } }, h("span", { class: "icon is-small" }, h("attachment-icon", { "icon-name": "retry" })))));
        if (!this.loading)
            return (h("div", { class: "control " }, h("a", { class: "button is-info", onClick: () => { this.openModal(); } }, h("span", { class: "icon is-small" }, h("attachment-icon", { "icon-name": "attachment" })))));
    }
    renderModal() {
        if (this.Attachment && this.Attachment.attachmentId) {
            ...
            return (h(Tunnel.Provider, { state: { AttachmentKey: attachmentKey, AttachmentBusiness: this.attachmentBusiness } }, h("attachment-modal", { ref: el => (this.modal = el) })));
        }
    }
    componentDidLoad() {
