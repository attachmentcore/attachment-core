...
var CreateComponent = /** @class */ (function () {
    ...
    CreateComponent.prototype.postAttachment = function () {
        ...
        this.onRequest.emit({});
        this.AttachmentBusiness.Upload(model).then(function () {
...
var AttachmentBusiness = /** @class */ (function () {
    function AttachmentBusiness(baseUrl) {
        this.baseUrl = baseUrl;
    }
    AttachmentBusiness.prototype.Upload = function (model) {
        if (!model)
    ...
    AttachmentBusiness.prototype.GetAttachmentId = function (entityName, fieldName, entityId) {
        var params = {
    ...
    AttachmentBusiness.prototype.GetAllAttachmentItems = function (model) {
    ...
    AttachmentBusiness.prototype.Delete = function (model) {
    ...
    AttachmentBusiness.prototype.Download = function (model) {
...
var AttachmentInputComponent = /** @class */ (function () {
    ...
    AttachmentInputComponent.prototype.getAttachmentId = function () {
        ...
        this.loading = true;
        this.attachmentBusiness.GetAttachmentId(this.EntityName, this.FieldName, this.EntityId).then(function (response) {
    ...
    AttachmentInputComponent.prototype.renderModal = function () {
        ...
        if (this.Attachment && this.Attachment.attachmentId) {
            ...
            return (h(Tunnel.Provider, { state: { AttachmentKey: attachmentKey, AttachmentBusiness: this.attachmentBusiness } }, h("attachment-modal", { ref: function (el) { return (_this.modal = el); } })));
        }
    };
...
var TableComponent = /** @class */ (function () {
    ...
    TableComponent.prototype.componentDidLoad = function () {
        ...
        this.deleteComfirmation.addEventListener("onAccept", function (event) {
            _this.onStartLoading.emit({});
            _this.AttachmentBusiness.Delete(_this.getAttachmentItemKey(event.detail.id)).then(function () {
                _this.Refresh().then(function (data) {
                    _this.onEndLoading.emit(data);
                });
            });
    ...
    TableComponent.prototype.Load = function (pageIndex, pageSize) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.AttachmentBusiness.GetAllAttachmentItems({
